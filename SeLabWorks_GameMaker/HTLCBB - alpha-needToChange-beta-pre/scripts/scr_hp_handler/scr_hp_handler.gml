...
if(p1.hp <=0 && p2.hp >0){
	...
	//if(isTimesUp){
		...
		draw_text_color(room_width/2-300,room_height/2+300,"Press Enter to continue",c_red,c_red,c_red,c_red,0.5)
	//}
	
	
	if(keyboard_check_pressed(vk_enter) && global.isGameOver){
