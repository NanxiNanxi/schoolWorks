...
if(p1.hp <=0 && p2.hp >0){
	...
	//if(isTimesUp){
		...
		draw_text_color(room_width/2-200,room_height/2-100,"Player 2, You Win!",c_red,c_red,c_red,c_red,0.8)
		draw_text_color(room_width/2-300,room_height/2+300,"Press start to continue",c_red,c_red,c_red,c_red,0.5)
	//}
	...
	/**if(keyboard_check_pressed(vk_anykey) && global.isGameOver && room = rm_game2){
		room_persistent = false; 
		room_goto(rm_game_over)
	}**/
...
if(p2.hp <=0 && p1.hp>0){
	...
	draw_set_font(fnt_ending)
	draw_text_color(room_width/2-200,room_height/2-100,"Player 1, You Win!",c_red,c_red,c_red,c_red,0.8)
	draw_text_color(room_width/2-300,room_height/2+300,"Press start to continue",c_red,c_red,c_red,c_red,0.5)
	...
	/**if(keyboard_check_pressed(vk_anykey) && global.isGameOver && room = rm_game){
		room_persistent = false; 
