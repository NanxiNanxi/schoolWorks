class Invoice
     ...
     class InvoiceItem
    {
        ...
        {
            this.itemTotalPrice = this.itemPrice * this.itemQuatity;
        }
        public override string ToString()
        {
    ...
    public partial class MainWindow : Window
    {
        ...
        private void DeleteBtn_Click(object sender, RoutedEventArgs e)
        {
            ...
            //but also to delete all the invoice records for that invoiceID.
        ...
        public void loadInvoiceItem()
        {
            ...
            using (SqlConnection connection = new SqlConnection())
            {
                ...
                //I create an extra list for all the invoice items, then when Invoice item table's invoiceID equals to invoice table's invoice ID,
